...
export default function ModalContent({ open, onOpenChange, item }: ModalContentProps) {
...
>
        {modalItem ? (
          <>
            <DialogHeader>
              <DialogTitle className="text-2xl md:text-3xl">{modalItem.title}</DialogTitle>
              <DialogDescription className="text-base md:text-lg">{modalItem.description}</DialogDescription>
            </DialogHeader>
            ...
            <div className="mt-4 space-y-6">
              ...
              <div className="space-y-4">
                ...
                {modalItem.technologies && modalItem.technologies.length > 0 && (
                  <div>
                    <h3 className="text-lg font-semibold mb-2">Teknolojiler</h3>
