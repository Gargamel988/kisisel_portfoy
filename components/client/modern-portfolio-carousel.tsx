...
export default function ModernPortfolioCarousel({
  ...
  // Scroll animasyonu için ref ve inView
                  ...
                  <div className="relative z-10 h-full flex items-end p-3 sm:p-4 md:p-6 lg:p-8 xl:p-10 2xl:p-12">
                    <div className="max-w-full sm:max-w-xl md:max-w-2xl lg:max-w-3xl xl:max-w-4xl 2xl:max-w-5xl">
                      ...
                      <motion.div
                        ...
                        className="flex flex-wrap gap-1 sm:gap-2 mb-4 sm:mb-6 md:mb-8"
                      >
                      ...
                      {items[currentIndex].github && (
                        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 md:gap-4">
                          ...
                          >
                            <Link href={items[currentIndex].link} target="_blank">
                              <button className="w-full sm:w-auto px-4 sm:px-6 md:px-8 py-2 sm:py-2.5 md:py-3 bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-semibold rounded-lg sm:rounded-xl text-sm sm:text-base md:text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-green-500/25">
                                Projeyi İncele
                              </button>
                            </Link>
                          </motion.div>
                          <motion.div
                            ...
                            className="flex-1 sm:flex-none"
                          >
                            <Link href={items[currentIndex].github} target="_blank">
                              <button className="w-full sm:w-auto px-4 sm:px-6 md:px-8 py-2 sm:py-2.5 md:py-3 bg-white text-green-500 font-semibold rounded-lg sm:rounded-xl text-sm sm:text-base md:text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-green-500/25">
                                Github
                              </button>
                            </Link>
                          </motion.div>
