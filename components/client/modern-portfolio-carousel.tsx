            ...
            >
              {items.map((_, index) => (
                <button
                  ...
                  className={
                    `${index === currentIndex ? "bg-green-400 scale-125 shadow-lg shadow-green-400/50" : "bg-white/30 hover:bg-white/50"} w-2 h-2 md:w-4 md:h-4 rounded-full transition-all duration-300`
                  }
                />
              ))}
            </motion.div>
